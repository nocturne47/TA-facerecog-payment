        ...
        <table>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="notel" id="notel" required="required">
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div class="container-sm pl-5 pr-5 ml-5 mr-5">
            <form class="form-signin pl-5 pr-5 ml-5 mr-5" action="" method="post">
                ...
                <div class="form-label-group pl-5 pr-5 ml-5 mr-5">
                    <label for="nama">Nama</label>
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama anda..." required="" autofocus="">
                    <!-- <label for="username">Username</label> -->
                </div>
                <div class="form-label-group pl-5 pr-5 ml-5 mr-5">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" class="form-control" placeholder="Masukkan alamat email anda..." required="" autofocus="">
                    <!-- <label for="username">Username</label> -->
                </div>
                <div class="form-label-group pl-5 pr-5 ml-5 mr-5">
                    <label for="notel">No. Telp</label>
                    <input type="text" name="notel" id="notel" class="form-control" placeholder="Masukkan nomor telepon anda..." required="" autofocus="">
                    <!-- <label for="username">Username</label> -->
                </div>
                <div class="form-label-group pl-5 pr-5 ml-5 mr-5">
                    <label for="username">Username</label>
