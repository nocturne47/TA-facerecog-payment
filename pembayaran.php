...
$nambar=$_GET['barang'];
$prod=query("SELECT * FROM barang WHERE barang='$nambar'")[0];
...
if(isset($_POST['beli'])){
    ...
    $jlh=$_POST['jumlah'];
    $_SESSION['beli']=true;
    $harga=$jlh*$prod['harga'];
    setcookie('harga',$harga, time()+60*5);
    setcookie('barang',$nambar, time()+60*5);
    setcookie('jumlah',$jlh, time()+60*5);
...
<html>
    ...
    <body>
        ...
        <p>Silahkan tentukan pembelian anda</p>
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td>
                        <input type="submit" id="beli" name="beli" value="Beli">
                    </td>
                </tr>
            </table>
        </form>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-item nav-link active" href="pembelian.php">Pembelian</a>
        ...
        <div class="container-sm pl-5 pr-5 ml-5 mr-5">
            <form class="form-signin pl-5 pr-5 ml-5 mr-5" action="" method="post">
                ...
                <div class="text-center mb-4">
                    <img class="mb-4" src="gambar/<?=$prod['gambar']?>" alt="" width="72" height="72">
                    <h1 class="h3 mb-3 font-weight-normal"><?=$prod['barang']?></h1>
                ...
                <div class="form-label-group pl-5 pr-5 ml-5 mr-5 mb-5">
                    <label for="topup">Jumlah</label>
                    <input type="number" name="jumlah" id="jumlah" min="1" max="30" class="form-control" placeholder="Nominal" required="" autofocus="">
                    <!-- <label for="username">Username</label> -->
                </div>
                ...
                <div class="row pl-5 pr-5 ml-5 mr-5">
                    <button class="btn btn-lg btn-primary btn-block" name="beli" id="beli" type="submit">Beli</button>
                </div>
            </form>
        </div>
    </div>
